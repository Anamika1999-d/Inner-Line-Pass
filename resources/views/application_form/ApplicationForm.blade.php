...
<head>
    ...
    <script type="text/javascript">
        function myCheckBox(obj) {
          if($(obj).is(":checked")){
           document.getElementById("Permanent_Address_Hno").value=document.getElementById("Present_Address_Hno").value;
           document.getElementById("Permanent_Address_Sub_locality1").value=document.getElementById("Present_Address_Sub_locality1").value;
           document.getElementById("Permanent_Address_Sub_locality2").value=document.getElementById("Present_Address_Sub_locality2").value;
           document.getElementById("Permanent_Address_Location").value=document.getElementById("Present_Address_Location").value;
           document.getElementById("Permanent_Address_Sub_District").value=document.getElementById("Present_Address_Sub_District").value;
           document.getElementById("Permanent_Address_District").value=document.getElementById("Present_Address_District").value;
           document.getElementById("Permanent_Address_State").value=document.getElementById("Present_Address_State").value;
           document.getElementById("Permanent_Address_pin_code").value=document.getElementById("Present_Address_pin_code").value;
           document.getElementById("Permanent_Address_Country").value=document.getElementById("Present_Address_Country").value;
           document.getElementById("Permanent_Address_Police_Station").value=document.getElementById("Present_Address_Police_Station").value;
           document.getElementById("Permanent_Address_Post_office").value=document.getElementById("Present_Address_Post_office").value;
        
          }else{
            document.getElementById("Permanent_Address_Hno").value='';
           document.getElementById("Permanent_Address_Sub_locality1").value='';
           document.getElementById("Permanent_Address_Sub_locality2").value='';
           document.getElementById("Permanent_Address_Location").value='';
           document.getElementById("Permanent_Address_Sub_District").value='';
           document.getElementById("Permanent_Address_District").value='';
           document.getElementById("Permanent_Address_State").value='';
           document.getElementById("Permanent_Address_pin_code").value='';
           document.getElementById("Permanent_Address_Country").value='';
           document.getElementById("Permanent_Address_Police_Station").value='';
           document.getElementById("Permanent_Address_Post_office").value='';
          }
    ...
    <div class="Applicationform">
        ...
        @csrf
            ...
            <div id="personalDetail" class="block">
                ...
                <li> Email : <input type="email" name="Email" placeholder="abc@mail.com">
                @error('Email')
                ...
                <li><p class="address">Permanent Address :-- <input type="checkbox" name="filladdress" id="filladdress" onclick="myCheckBox(this)">:Same as present Address </p>
                ...
                <fieldset>
                    ...
                    EPIC/UID No. of Sponsor : <input type="file" name="doc1" >    
        ...
        <input type="submit" value="Submit" id="Submit" class="store_btn" >
        </form>
</div>
